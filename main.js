...
function calcPopoverPosition(button, popover) {
  var _button$getBoundingCl = button.getBoundingClientRect(),
    top = _button$getBoundingCl.top,
    left = _button$getBoundingCl.left;
  var popoverTop = "calc(".concat(window.scrollY + top - popover.offsetHeight, "px - 0.7rem)");
  var popoverLeft = "".concat(window.scrollX + left + button.offsetWidth / 2 - popover.offsetWidth / 2, "px");
  return [popoverTop, popoverLeft];
}
;// CONCATENATED MODULE: ./src/js/toggle.js
...
var PopoverToggle = /*#__PURE__*/function () {
  function PopoverToggle() {
    _classCallCheck(this, PopoverToggle);
    this.container = document.querySelector('.container');
    this.button = document.querySelector('.popover-toggle');
    this.togglePopover = this.togglePopover.bind(this);
    this.popover = null;
  }
  _createClass(PopoverToggle, [{
    key: "init",
    value: function init() {
    ...
    value: function togglePopover() {
      if (this.popover !== null) {
        ...
        var _calcPopoverPosition = calcPopoverPosition(this.button, this.popover),
          _calcPopoverPosition2 = _slicedToArray(_calcPopoverPosition, 2),
          top = _calcPopoverPosition2[0],
          left = _calcPopoverPosition2[1];
